...
plotRefToTarget(PCA$shapes$shapes.comp3$min, meanshape,
                method = "vector",
                mag = 2)
```
...
```{r}
#| label: PC3 Min vs Mean Shape
plotRefToTarget(PCA$shapes$shapes.comp3$max, meanshape,
                method = "vector",
                mag = 2)
```
