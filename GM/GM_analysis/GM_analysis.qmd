...
-   The y column in `BedCoordinates.csv` is the relative vertical distance from the bottom of the figure in meters.
-   The x column in `KyrCoordinates.csv` is the relative horizontal distance from the left of the figure in meters.
